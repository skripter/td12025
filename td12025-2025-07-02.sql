...
--
-- Servidor: localhost
-- Tiempo de generación: 02-07-2025 a las 19:20:36
...
(1, 'Herman Hesse', NULL),
(2, 'Marco Aurelio', NULL),
(3, 'Séneca', NULL),
(4, 'Epicteto', NULL),
(5, 'Lao-Tsé', NULL),
(6, 'Julían Murguía', NULL),
(7, 'Marco Tulio Cicerón', NULL),
(8, 'Antoine de Saint-Exupéry', NULL);
...
--
ALTER TABLE `libros`
  MODIFY `libid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
